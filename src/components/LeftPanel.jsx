    ...
    <>
      ...
      <aside className={`lp ${show?'s':''}`}>
        <div className="lp-top">
          <div className="lp-brand">MoonChat</div>
          <button className="lp-menu-item new" onClick={onNew}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/></svg>
            <span>新对话</span>
          </button>
          <button className="lp-menu-item">
        ...
        <div className="lp-section-label">历史对话</div>
        ...
        <div className="lp-footer">
          <div className="lp-user"><div className="lp-avatar">M</div><span className="lp-username">暮暮</span></div>
