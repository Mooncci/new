    ...
    <div className="tp-wrap">
      ...
      <div className={`tp ${expanded?'expanded':''}`}>
        <div className="tp-header" onClick={() => setExpanded(!expanded)}>
          <div style={{width:24}} />
          <span className="tp-title-text">Thinking</span>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B5AD9E" strokeWidth="2" strokeLinecap="round" style={{transform:expanded?'rotate(180deg)':'rotate(0)',transition:'transform .3s',flexShrink:0}}><path d="M18 15l-6-6-6 6"/></svg>
        </div>
